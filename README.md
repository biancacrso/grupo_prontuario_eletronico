...
**Solução:** Desenvolvimento de um sistema de Prontuário Eletrônico do Paciente que permita o armazenamento digital, centralizado e seguro dos prontuários. O sistema possibilita a localização rápida das informações, reduz o uso de papel, elimina a dependência de espaço físico e garante maior legibilidade, integridade e agilidade na disponibilização dos documentos quando solicitados.

## Grupo formado por: 

Aryelson Freitas dos Santos;
Bianca Pereira Cardoso;
Gabriel Lucas Pereira Gutemberg;
Hellisan Mylla Rodrigues Xavier.
